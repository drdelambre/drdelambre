...
class Model {
	...
	clear() {
		...
		for (ni in this._def) {
			if (this._def[ni].default instanceof Model ||
					(type(this._def[ni].default, 'function') &&
						this._def[ni].default.prototype instanceof Model)) {
				this[ni] = new this._def[ni].default();
